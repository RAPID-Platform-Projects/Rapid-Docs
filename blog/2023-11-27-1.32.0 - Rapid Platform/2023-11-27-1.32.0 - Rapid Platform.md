...
A search box is added to the KanBan Boards component. This can be used to search items on the Board based on provided keyword(s). The behavior is identical to the Search items field already present in Data Table List.
