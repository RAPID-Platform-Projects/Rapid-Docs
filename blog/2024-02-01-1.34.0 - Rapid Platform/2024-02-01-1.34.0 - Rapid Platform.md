...
3. All the other column properties apply to the Date type like - it can be set as title column, toggle if this column can be "Searchable", toggle if the column can be "In All View" etc.
:::
