...
:::info[Application]
An application of this feature can be thought of as Password.
If the Password matches, then the validation criteria is met. Else, a text like "You entered incorrect password" can be displayed.
:::
