...
Imagine a Project Manager analysing a pie chart created on the different project statuses on the List page of the Projects table. 

OR

Imagine yourself as a finance manager, looking at the bar graph of total value and average value of assets grouped on asset types, on the Assets Table itself.
...
The <a href="https://rapiddocs.z8.web.core.windows.net/docs/Rapid/User%20Manual/glossary/#composition-area" target="_blank">**Counter**</a> is an existing component, however, the Visual component has a capability to configure a counter and with a greater capacity to express data (discussed later in this article).   
