...
We're excited to announce new features live on Rapid Platform **Thursday, March 26th**

## Features

### Folder nesting under a parent table

You can now organise item folders under a parent table in document storage. Choose whether items link to the parent using a lookup or universal link, and whether folders are shared or created per item, keeping documents grouped automatically. [Learn more about Folder Nesting](/docs/folder-nesting)
