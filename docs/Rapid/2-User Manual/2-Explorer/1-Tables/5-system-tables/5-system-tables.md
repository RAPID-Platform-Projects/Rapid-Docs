...
Tasks generated by a [process diagram](</docs/Rapid/2-User Manual/4-Workflow/4-Workflow.md>) provide a powerful way for users to interact with automated business logic.

- For more information about how tasks interact with **Workflow**, see the [Workflow - User task section](</docs/Rapid/3-Keyper Manual/3-Workflow/3-Execution/5-Activities/user-task/user-task.md>)
