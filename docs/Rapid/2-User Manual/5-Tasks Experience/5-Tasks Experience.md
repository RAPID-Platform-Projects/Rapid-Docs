...
- This can provide further security, as some employees might only need to access their Tasks (as opposed to being able to access the entirety of a Rapid site). This functionality can, however, be implemented using [Permissions](</docs/Rapid/2-User Manual/2-Explorer/1-Tables/6-permissions/6-permissions.md>).
...
- **Tasks Experience** integrates closely with **Adaptive Designer**, allowing forms to be created for all Tasks, and specialised forms to be created for certain [Task Inheritances and Subtypes](</docs/Rapid/2-User Manual/glossary/glossary.md#inherit-tables>).
...
2. **✓ Complete**
    ...
    > 2. It will trigger any [Workflow](</docs/Rapid/2-User Manual/4-Workflow/4-Workflow.md>) processes that are waiting for the task to be completed.
    > 3. It will remove the task from certain table or task [Views](</docs/Rapid/2-User Manual/2-Explorer/4-Views/1-Views-Overview/1-Views-Overview.md>), such as "My Tasks". It will also disappear in views dedicated to seeing upcoming tasks.
3. **Start Date**
