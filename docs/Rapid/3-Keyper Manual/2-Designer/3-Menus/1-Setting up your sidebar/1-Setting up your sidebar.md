...
[*Sidebars*](</docs/Rapid/2-User Manual/glossary/glossary.md#sidebar> "Sidebar") can be very useful in organizing pages and navigating to the required ones quickly.
...
[How to add new menu items?](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/how-to-create-new-menu-item/how-to-create-new-menu-item.md "How to create a new menu item, set display text and icon?")

[How to add a menu item below an existing item?](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/how-to-add-a-menu-below/how-to-add-a-menu-below.md "How to edit / delete / add an item below an existing item?")
