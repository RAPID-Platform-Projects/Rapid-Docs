...
This article relates to menus configured for both [Side Bar](</docs/Rapid/2-User Manual/glossary/glossary.md#sidebar>) and [Command Bar](</docs/Rapid/2-User Manual/glossary/glossary.md#command-bar>) menu types.
...
[How to create Menu buttons in command bar of a data table?](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/how-to-configure-a-command-bar-button/how-to-configure-a-command-bar-button.md "How to configure a Menu button in a command bar?")
