...
[Displaying text and icon on a menu button ](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/3-menu-button-configuration.md "How to set display text and icon for a menu item?")
