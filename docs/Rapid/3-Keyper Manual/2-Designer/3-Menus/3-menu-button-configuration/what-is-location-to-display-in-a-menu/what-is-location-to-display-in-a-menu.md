...
This is configurable on the **[Command Bar](</docs/Rapid/2-User Manual/glossary/glossary.md#command-bar>)** menu type.
...
[Displaying text and icon on a menu button ](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/how-to-create-new-menu-item/how-to-create-new-menu-item.md "How to set display text and icon for a menu item?")
...
[Save Intention field](/docs/Rapid/3-Keyper%20Manual/2-Designer/3-Menus/3-menu-button-configuration/what-is-save-intention-in-a-menu/what-is-save-intention-in-a-menu.md "What is Save Intention option in a Menu setup?")
