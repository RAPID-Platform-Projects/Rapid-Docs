...
- You can learn about [how to configure menu buttons to launch workflow processes](</docs/Rapid/3-Keyper Manual/2-Designer/3-Menus/Menu Actions/execute-workflow-process/execute-workflow-process.md>).

## Signal Start Events

Another method for executing a **Workflow** process is to begin with a [Signal Start Event](</docs/Rapid/3-Keyper Manual/3-Workflow/3-Execution/3-Events/1-start-events/1-start-events.md>). These **Signal** events can detect when an item is **created** or **updated** on a particular table. This then causes the **Workflow** process diagram to begin automatically.