# Chapter Introduction and Video

This chapter covers two aspects:

## 1) How to create a new Dynamic Template in SendGrid. 

In this part of the chapter, we will discuss the exact sequence of steps needed to create a new Dynamic template.

In the process, we will encounter two steps of template selection and editor selection.
