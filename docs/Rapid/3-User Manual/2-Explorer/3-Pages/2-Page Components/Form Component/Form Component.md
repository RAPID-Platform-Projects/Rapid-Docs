...
These physical forms are simply [fields](</docs/todo>) of data, just like in Rapid. When you submit a form to your dentist, you are really submitting a collection of fields (e.g. *Name*, *Private Health Insurance*, *Date of Birth*, etc.)
