...
For a more in-depth set of examples check out our <a href="https://docs.rapidplatform.com/training">Training</a> modules, especially <!-- #REE Link to Extending and customing modules "Extending and Customising Modules" -->.
