...
In Designer, you can configure a [**page to host components**](/docs/Rapid/3-User%20Manual/Glossary/glossary.md#page-layout-and-component "Page and component"). Rapid Platform provides you with a set of 19 components. You can create or update pages in two ways:
