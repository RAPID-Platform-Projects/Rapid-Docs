...
Creating a new Menu item is same through all functions - [***Sidebars***](/docs/Rapid/3-User%20Manual/Glossary/glossary.md#sidebar "Sidebar") or ***[Command bar](/docs/Rapid/3-User%20Manual/Glossary/glossary.md#command-bar "Command bar")***. There are some default menu items already prepared by the system. You can create new items in the tree.
