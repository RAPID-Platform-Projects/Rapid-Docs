...
Please note when configuring on the ***[Side Bar](/docs/Rapid/3-User%20Manual/glossary/glossary.md#sidebar)*** menu the **Include Item**, **Single Request**, **Silent**, **Include Form**, and **Select Forms** options although visible will not do anything in this context but are used in ***[Command Bar](/docs/Rapid/3-User%20Manual/glossary/glossary.md#menu)*** menu type.
